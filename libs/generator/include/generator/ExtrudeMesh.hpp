...
public:
    ...
    public:
        Triangle generate() const {
            ...
            if ( odd_ == 0 ) {
                triangle.vertices[0] = shapeEdge.vertices[0] + pathEdge.vertices[0] * mesh_->shapeVertexCount_;
                triangle.vertices[1] = shapeEdge.vertices[1] + pathEdge.vertices[1] * mesh_->shapeVertexCount_;
                triangle.vertices[2] = shapeEdge.vertices[0] + pathEdge.vertices[1] * mesh_->shapeVertexCount_;
            } else {
                triangle.vertices[0] = shapeEdge.vertices[0] + pathEdge.vertices[0] * mesh_->shapeVertexCount_;
                triangle.vertices[1] = shapeEdge.vertices[1] + pathEdge.vertices[0] * mesh_->shapeVertexCount_;
                triangle.vertices[2] = shapeEdge.vertices[1] + pathEdge.vertices[1] * mesh_->shapeVertexCount_;
            }
